function BuildOneFLOW() {
    ...
    cmake --help
    cmake -G "Visual Studio 14 2015 Win64" -SC:/projects/OneFLOW-overset -BC:/projects/OneFLOW-overset/build/ `
    -DAUTO_CI_TEST=ON -DCMAKE_INSTALL_PREFIX="C:/Program Files/OneFLOW-overset"
